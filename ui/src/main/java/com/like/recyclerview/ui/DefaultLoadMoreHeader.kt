...
import com.like.recyclerview.model.ILoadMoreHeader

/**
 * 用于 RecyclerView 的往前加载更多的视图
 *
 ...
 */
data class DefaultLoadMoreHeader(
    val loadingTip: String = "加载中……",
    val noMoreDataTip: String = "到顶啦",
    ...
    override val layoutId: Int = R.layout.recyclerview_default_loadmore_header
    override fun variableId(): Int = BR.loadMoreHeader
