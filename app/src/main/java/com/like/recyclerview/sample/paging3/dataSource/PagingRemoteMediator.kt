...
//            // thread.
//            val bannerInfoList = bannerDataSource.load() ?: emptyList()
//            val topArticleEntityList = topArticleDataSource.load() ?: emptyList()
...
//                // in the DB.
//                bannerEntityDao.insert(*bannerInfoList.toTypedArray())
